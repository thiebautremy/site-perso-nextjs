    ...
    <div className={styles.tarifsContainer}>
      <Container margin="isHuge">
        ...
        <div className={styles.content}>
          ...
          <p>
            Webosaurus est une agence web qui propose des services de qualité à
            des tarifs abordables. L&apos;agence accompagne ses clients à chaque
            étape du processus de création de site internet, de la conception à
            la maintenance.
          </p>
          <p>
